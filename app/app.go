...
import (
	...
	// App Params.
	appparameters "github.com/reecepbcups/joe/app/params"
...
var (
	// Clean this up in the future to its own
	Upgrades = []Upgrade{
		{
			UpgradeName: "v2",
...
var _ servertypes.Application = (*JoeApp)(nil)

// JoeApp extends an ABCI application, but with most of its parameters exported.
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".joed")
}

// NewJoeApp returns a reference to an initialized JoeApp.
func NewJoeApp(
	logger log.Logger,
	db dbm.DB,
...
func (app *JoeApp) setAnteHandler(appOpts servertypes.AppOptions, txConfig client.TxConfig) {
...
func (app *JoeApp) setPostHandler() {
...
func (app *JoeApp) Name() string { return app.BaseApp.Name() }

// BeginBlocker application updates every begin block
func (app *JoeApp) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
	return app.mm.BeginBlock(ctx, req)
}

// EndBlocker application updates every end block
func (app *JoeApp) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

// InitChainer application update at chain initialization
func (app *JoeApp) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *JoeApp) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *JoeApp) ModuleAccountAddrs() map[string]bool {
...
// LegacyAmino returns JoeApp's amino codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *JoeApp) LegacyAmino() *codec.LegacyAmino {
	return app.legacyAmino
}

// AppCodec returns JoeApp's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *JoeApp) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns JoeApp's InterfaceRegistry
func (app *JoeApp) InterfaceRegistry() types.InterfaceRegistry {
...
func (app *JoeApp) GetKey(storeKey string) *storetypes.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *JoeApp) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *JoeApp) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *JoeApp) GetSubspace(moduleName string) paramstypes.Subspace {
	subspace, _ := app.ParamsKeeper.GetSubspace(moduleName)
	return subspace
}

// SimulationManager implements the SimulationApp interface
func (app *JoeApp) SimulationManager() *module.SimulationManager {
	return app.sm
}

// RegisterAPIRoutes registers all application module routes with the provided
// API server.
func (app *JoeApp) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *JoeApp) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *JoeApp) RegisterTendermintService(clientCtx client.Context) {
