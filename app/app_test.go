...
func TestJoeAppExportAndBlockedAddrs(t *testing.T) {
	...
	app2 := NewJoeApp(logger2, db, nil, true, map[int64]bool{}, DefaultNodeHome, 0, encCfg, GetEnabledProposals(), EmptyAppOptions{}, emptyWasmOpts)
...
func TestRunMigrations(t *testing.T) {
	...
	encCfg := MakeTestEncodingConfig()
	logger := log.NewTMLogger(log.NewSyncWriter(os.Stdout))
	app := NewJoeApp(logger, db, nil, true, map[int64]bool{}, DefaultNodeHome, 0, encCfg, GetEnabledProposals(), EmptyAppOptions{}, nil)
