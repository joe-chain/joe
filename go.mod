module github.com/reecepbcups/joe
...
require (
	github.com/CosmosContracts/juno/v13 v13.0.0-beta // indirect
...
replace (
	...
	// dragonberry: https://github.com/cosmos/cosmos-sdk/releases/tag/v0.46.6
