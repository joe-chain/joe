...
update_test_genesis () {
    ...
    # SingleInstance: cat $HOME/.joed/config/genesis.json | jq "$1" > $HOME/.joed/config/tmp_genesis.json && mv $HOME/.joed/config/tmp_genesis.json $HOME/.joed/config/genesis.json
